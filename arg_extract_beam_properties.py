...
def run_one(
    ...
    *,
    ...
    # Pixel xy coordinates are fixed for this fov_dict.
    fov_points_xy = pixels_coordinates(fov_dict)
...
def main():
    ...
    ap.add_argument("--t8", action="store_true", help="sum T8 PPDF pose files and extract one properties file per layout")
